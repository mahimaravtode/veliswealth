...
export const createAnimation = (
  ...
  if (variant === "rectangle") {
    if (start === "bottom-up" || start === "top-down") {
      const maskPosition = start === "bottom-up" ? "bottom" : "top";
      const transformOrigin = start === "bottom-up" ? "bottom center" : "top center";
      const svg = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" fill="white"/></svg>`;
      ...
      return {
        ...
        ::view-transition-new(root) {
          mask: url('${svg}') ${maskPosition} center / 100% 0% no-repeat;
          mask-origin: content-box;
          animation: rectangle-reveal-${start}${blur ? "-blur" : ""} 0.7s;
        ...
        @keyframes rectangle-reveal-${start}${blur ? "-blur" : ""} {
          from {
            mask-size: 100% 0%;
